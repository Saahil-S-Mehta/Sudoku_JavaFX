...
public class UserInterfaceImpl implements IUserInterfaceContract.View,
    ...
    private static final Color WINDOW_BACKGROUND_COLOR = Color.rgb(255, 0, 0);
    private static final Color BOARD_BACKGROUND_COLOR = Color.rgb(255, 242, 241);
    private static final String SUDOKU = "SUDOKU";
    private static final String NAME = "By: Sanga Bhavesh(1RV19CS136)\n      Saahil Mehta(1RV19CS133)";
    ...
    private void drawTitle(Group root) {
        Text title = new Text(290, 35, SUDOKU);
        title.setFill(Color.BLACK);
        Font titleFont = new Font(30);
        title.setFont(titleFont);
        root.getChildren().add(title);
        Text name = new Text(220, 690, NAME);
